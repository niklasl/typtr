...
class JavaTranspiler(CStyleTranspiler):
    ...
    def _output_prelude(self):
        self.outln('/**')
        self.outln(' * This file was automatically generated by TypTr.')
        ...
        self.outln()
        # TODO: Copy these into result package.
        #self.stmt(f'import {self.package_root}.Builtins')
        #self.stmt(f'import {self.package_root}.KeyValue')
        self.outln()
